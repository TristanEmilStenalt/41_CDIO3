...
public class  MonopolyGUI{
    ...
    public void fieldCreation() //forsøg på at bruge GUI. opsætning af bræt.
    {
        ...
        GUI_Player gui_Player1 = new GUI_Player("Player 1: VET", 1000, car1);
        ...
        GUI_Player gui_Player2 = new GUI_Player("Player 2: RIC", 1000, car2);
        ...
        GUI_Player gui_Player3 = new GUI_Player("Player 3: LEC",1000, car3);
        ...
        GUI_Player gui_Player4 = new GUI_Player("Player 4: MAG",1000, car4);
